...
██║ ╚═╝ ██║╚██████╔╝███████║   ██║       ██████╔╝███████╗
╚═╝     ╚═╝ ╚═════╝ ╚══════╝   ╚═╝       ╚═════╝ ╚══════╝
 kNumberSystemBase = 10;
 kMaxDigitsInElement = 1;
 */
...
TEST(OPERATORS_SUM, NEGATIVE_NUMBER) {
  {
    BigInt a(12'999'999'999);
    BigInt b("-999999999");
    std::cout << a << " " << b << '\n';
    BigInt c = a + b;
    std::cout << c;
    EXPECT_EQ(c, 12000000000);
  }
  {
    BigInt a(-12'999'999'999);
    BigInt b("12999999999");
    std::cout << a << " " << b << '\n';
    BigInt c = a + b;
    std::cout << c;
    EXPECT_EQ(c, 0);
...
void TestDiv(T num1, U num2) {
  ...
  BigInt b(num2);
  BigInt c = a / b;
  EXPECT_EQ(c, num1 / num2) << " with " << a << " " << b;
  std::cout << std::endl << "Your result - " << c << " but correct - " << num1/num2;
}

TEST(DIV, BASIC) {
  TestDiv(4, 2);
  TestDiv(7876521, 1223333);
...
// TEST(DIV, BIG) {
//     BigInt
//     a("12345123456789012345678923456789123534645723452363465473643423");
...
TEST(IO, BASIC) {
    std::istringstream iss("1234567890123456789012345\n-1234567890123456789012\n");
